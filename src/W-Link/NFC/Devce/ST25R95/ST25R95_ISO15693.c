...
ST25R95_OpResult ST25R95_ISO15693_PhyConfigure(const ST25R95_ISO15693_PhyConfig_t *config, const struct ST25R95_ISO15693_StreamConfig **needed_stream_config)
{
  ...
  memcpy((uint8_t *)&ST25R95_ISO15693_PhyConfig, (const uint8_t *)config, sizeof(ST25R95_ISO15693_PhyConfig_t));
                                               ...
                                               uint8_t *outbuf, uint16_t outBufSize, uint16_t *actOutBufSize)
{
  ...
  *actOutBufSize = 0;
  ...
  if (ISO15693_VCD_CODING_1_4 == ST25R95_ISO15693_PhyConfig.coding) {
    sof = ISO15693_DAT_SOF_1_4;
    eof = ISO15693_DAT_EOF_1_4;
    txFunc = ST25R95_ISO15693_PhyVCDCode1Of4;
    *subbit_total_length = (
                             (1U   /* SOF */
    ...
    txFunc = ST25R95_ISO15693_PhyVCDCode1Of256;
    *subbit_total_length = (
                             (1U   /* SOF */
