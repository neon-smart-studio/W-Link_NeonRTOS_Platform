...
static const ADC_Channel_Def ADC_Channel_Def_Table[hwADC_Channel_Index_MAX] =
{
    ...
    /* ADC1 */
    { hwGPIO_Pin_B4, hwADC_Instance_2 },   // AIN10
    { hwGPIO_Pin_B5, hwADC_Instance_2 },   // AIN11

    { hwGPIO_Pin_D3, hwADC_Instance_2 },   // AIN12
    { hwGPIO_Pin_D2, hwADC_Instance_2 },   // AIN13
    { hwGPIO_Pin_D1, hwADC_Instance_2 },   // AIN14
    { hwGPIO_Pin_D0, hwADC_Instance_2 },   // AIN15

    { hwGPIO_Pin_K0, hwADC_Instance_2 },   // AIN16
    { hwGPIO_Pin_K1, hwADC_Instance_2 },   // AIN17
    { hwGPIO_Pin_K2, hwADC_Instance_2 },   // AIN18
    { hwGPIO_Pin_K3, hwADC_Instance_2 },   // AIN19
};
