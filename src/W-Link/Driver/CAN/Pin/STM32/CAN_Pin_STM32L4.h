#ifndef CAN_PIN_STM32L4_H
#define CAN_PIN_STM32L4_H

#include "CAN_Pin_STM32_Def.h"
...
static const CAN_Pin_Def CAN_Pin_Def_Table[hwCAN_Index_MAX][CAN_Pinset_MAX] =
{
    ...
    {
        /* DEFAULT */
        { hwGPIO_Pin_A12, hwGPIO_Pin_A11 },   // TX, RX

        /* ALT1 */
        { hwGPIO_Pin_B9,  hwGPIO_Pin_B8  },   // TX, RX

        /* ALT2 */
        { hwGPIO_Pin_D1,  hwGPIO_Pin_D0  },   // TX, RX
    },
#endif
    ...
    {
        /* DEFAULT */
        { hwGPIO_Pin_B6,  hwGPIO_Pin_B5  },   // TX, RX

        /* ALT1 */
        { hwGPIO_Pin_B13, hwGPIO_Pin_B12 },   // TX, RX
