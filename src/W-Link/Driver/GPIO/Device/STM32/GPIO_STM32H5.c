...
#endif
#if defined(GPIOJ)
  else if (base == GPIOJ) { __HAL_RCC_GPIOJ_CLK_ENABLE(); }
#endif
#if defined(GPIOK)
  else if (base == GPIOK) { __HAL_RCC_GPIOK_CLK_ENABLE(); }
#endif
}
...
#endif
#if defined(GPIOJ)
  else if (base == GPIOJ) { __HAL_RCC_GPIOJ_CLK_DISABLE(); }
#endif
#if defined(GPIOK)
  else if (base == GPIOK) { __HAL_RCC_GPIOK_CLK_DISABLE(); }
#endif
}
