...
static const UART_AF_Map UART_Pin_AF_Map[] = {
    ...
    { hwUART_Index_0, hwGPIO_Pin_G11, GPIO_AF7_USART1 },
...
#if defined(GPIO_AF3_USART2)
    { hwUART_Index_1, hwGPIO_Pin_A14, GPIO_AF3_USART2 },
