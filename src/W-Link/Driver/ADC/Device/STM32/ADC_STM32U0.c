...
{
#if defined(STM32U031xx)
    HAL_NVIC_SetPriority(ADC_COMP1_IRQn, ADC_IRQ_NVIC_PRIORITY, ADC_IRQ_NVIC_SUB_PRIORITY);
    HAL_NVIC_EnableIRQ(ADC_COMP1_IRQn);
#elif defined(STM32U073xx) || defined (STM32U083xx)
    HAL_NVIC_SetPriority(ADC_COMP1_2_IRQn, ADC_IRQ_NVIC_PRIORITY, ADC_IRQ_NVIC_SUB_PRIORITY);
