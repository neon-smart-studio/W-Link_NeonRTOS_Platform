#ifndef UART_PIN_STM32L1_H
#define UART_PIN_STM32L1_H
...
#if defined(USART1_BASE) && defined(GPIO_AF7_USART1)
...
#if defined(USART2_BASE) && defined(GPIO_AF7_USART2)
...
#if defined(USART3_BASE) && defined(GPIO_AF7_USART3)
...
#if (defined(UART4_BASE) || defined(USART4_BASE)) && defined(GPIO_AF8_UART4)
...
#if (defined(UART5_BASE) || defined(USART5_BASE)) && defined(GPIO_AF8_UART5)
