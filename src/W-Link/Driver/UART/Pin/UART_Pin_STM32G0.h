...
#if defined(UART5_BASE) || defined(USART5_BASE)
    { hwUART_Index_4, hwGPIO_Pin_B3,  GPIO_AF3_USART5 },
    { hwUART_Index_4, hwGPIO_Pin_B4,  GPIO_AF3_USART5 },
    { hwUART_Index_4, hwGPIO_Pin_C12, GPIO_AF8_USART5 },
    { hwUART_Index_4, hwGPIO_Pin_D2,  GPIO_AF8_USART5 },
#endif

#if defined(UART6_BASE) || defined(USART6_BASE)
    { hwUART_Index_5, hwGPIO_Pin_B8, GPIO_AF3_USART6 },
    { hwUART_Index_5, hwGPIO_Pin_B9, GPIO_AF3_USART6 },
    { hwUART_Index_5, hwGPIO_Pin_C0, GPIO_AF4_USART6 },
    { hwUART_Index_5, hwGPIO_Pin_C1, GPIO_AF4_USART6 },
    { hwUART_Index_5, hwGPIO_Pin_C0, GPIO_AF8_USART6 },
    { hwUART_Index_5, hwGPIO_Pin_C1, GPIO_AF8_USART6 },
#endif
};
