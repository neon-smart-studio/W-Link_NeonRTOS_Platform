#ifndef SPI_PIN_STM32L0_H
#define SPI_PIN_STM32L0_H
...
#elif defined(SPI1_BASE) && defined(GPIO_AF5_SPI1)
...
#if defined(SPI2_BASE) && defined(GPIO_AF0_SPI2)
...
#elif defined(SPI2_BASE) && defined(GPIO_AF5_SPI2)
