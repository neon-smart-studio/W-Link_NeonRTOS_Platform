...
#if defined(UART7_BASE)
        case hwUART_Index_6: HAL_NVIC_DisableIRQ(UART7_IRQn); break;
#endif
#if defined(USART7_BASE)
        case hwUART_Index_6: HAL_NVIC_DisableIRQ(USART7_IRQn); break;
#endif

#if defined(UART8_BASE)
        case hwUART_Index_7: HAL_NVIC_DisableIRQ(UART8_IRQn); break;
#endif
#if defined(USART8_BASE)
        case hwUART_Index_7: HAL_NVIC_DisableIRQ(USART8_IRQn); break;
#endif
        default:
            break;
    }
