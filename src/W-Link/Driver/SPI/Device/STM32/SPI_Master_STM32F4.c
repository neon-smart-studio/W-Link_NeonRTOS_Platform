...
#endif
#if defined(SPI4_BASE)
        case hwSPI_Index_3: irq = SPI4_IRQn; break;
#endif
#if defined(SPI5_BASE)
        case hwSPI_Index_4: irq = SPI5_IRQn; break;
#endif
#if defined(SPI6_BASE)
        case hwSPI_Index_5: irq = SPI6_IRQn; break;
#endif
        default: return;
    }
...
#endif
#if defined(SPI4_BASE)
        case hwSPI_Index_3: HAL_NVIC_DisableIRQ(SPI4_IRQn); break;
#endif
#if defined(SPI5_BASE)
        case hwSPI_Index_4: HAL_NVIC_DisableIRQ(SPI5_IRQn); break;
#endif
#if defined(SPI6_BASE)
        case hwSPI_Index_5: HAL_NVIC_DisableIRQ(SPI6_IRQn); break;
#endif
    }
}
