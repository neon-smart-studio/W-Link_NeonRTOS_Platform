...
static HTS221_OpResult HTS221_IO_Map_I2C_Error(hwI2C_OpResult error_code)
{
    switch(error_code)
    {
        case hwI2C_OK:
...
HTS221_OpResult HTS221_IO_ReadByte(uint8_t RegisterAddr, uint8_t* value)
{
    if(value == NULL)
    {
        return HTS221_InvalidParameter;
...
HTS221_OpResult HTS221_IO_WriteByte(uint8_t RegisterAddr, uint8_t value)
{
