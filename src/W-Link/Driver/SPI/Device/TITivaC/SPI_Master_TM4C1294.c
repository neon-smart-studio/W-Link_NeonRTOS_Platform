...
uint32_t SPI_Map_GPIO_Port(hwSPI_Index index)
{
    switch (index)
    {
        ...
        case hwSPI_Index_1: return GPIO_PORTE_BASE;
        case hwSPI_Index_2: return GPIO_PORTD_BASE;
        case hwSPI_Index_3: return GPIO_PORTQ_BASE;
        default: return 0;
    }
}
...
uint32_t SPI_Map_GPIO_Periph(hwSPI_Index index)
{
    switch (index)
    {
        ...
        case hwSPI_Index_1: return SYSCTL_PERIPH_GPIOE;
        case hwSPI_Index_2: return SYSCTL_PERIPH_GPIOD;
        case hwSPI_Index_3: return SYSCTL_PERIPH_GPIOQ;
        default: return 0;
    }
}
...
uint32_t SPI_Map_GPIO_PinMask(hwSPI_Index index, bool cs)
{
    switch (index)
    {
        ...
        case hwSPI_Index_1:
            return GPIO_PIN_0 | GPIO_PIN_4 | GPIO_PIN_5 | (cs ? GPIO_PIN_1 : 0);
