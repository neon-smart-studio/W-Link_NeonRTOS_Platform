				    ...
				    const uint8_t* included_uuid, uint16_t *included_handle)
{
  ...
  included_start_handle = included_start_handle;
  memcpy(buffer+indx, &included_start_handle, 2);
  indx += 2;

  included_end_handle = included_end_handle;
                                                  ...
                                                  const uint8_t* value)
{
  ...
  cp.service_handle = service_handle;
  cp.char_handle = char_handle;
  cp.update_type = update_type;
  cp.char_length = char_length;
  cp.value_offset = value_offset;
