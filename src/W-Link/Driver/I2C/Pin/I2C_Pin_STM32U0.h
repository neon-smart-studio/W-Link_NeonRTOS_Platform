#ifndef I2C_PIN_STM32U0_H
#define I2C_PIN_STM32U0_H
...
#endif
    { hwI2C_Index_1, hwGPIO_Pin_A9,  GPIO_AF3_I2C2 },
    { hwI2C_Index_1, hwGPIO_Pin_A10, GPIO_AF3_I2C2 },
#endif
...
#if defined(I2C4_BASE)
    { hwI2C_Index_3, hwGPIO_Pin_B6, GPIO_AF2_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_B7, GPIO_AF2_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_B10, GPIO_AF3_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_B11, GPIO_AF3_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_C0, GPIO_AF2_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_C1, GPIO_AF2_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_D12, GPIO_AF4_I2C4 },
    { hwI2C_Index_3, hwGPIO_Pin_D13, GPIO_AF4_I2C4 },
#endif
};

#endif // I2C_PIN_STM32U0_H