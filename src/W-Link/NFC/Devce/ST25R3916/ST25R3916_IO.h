...
#define ST25R3916_IO_INTERFACE_SPI 1
#define ST25R3916_IO_INTERFACE_I2C 2

#ifdef CONFIG_ST25R3916_IO_INTERFACE_SPI
#define ST25R3916_IO_INTERFACE ST25R3916_IO_INTERFACE_SPI
#endif

#ifdef CONFIG_ST25R3916_IO_INTERFACE_I2C
#define ST25R3916_IO_INTERFACE ST25R3916_IO_INTERFACE_I2C
#endif

#if !defined(CONFIG_ST25R3916_IO_INTERFACE_SPI) && !defined(CONFIG_ST25R3916_IO_INTERFACE_I2C)
#define ST25R3916_IO_INTERFACE ST25R3916_IO_INTERFACE_SPI
#endif

#if defined(CONFIG_ST25R3916_IO_INTERFACE_SPI) && defined(CONFIG_ST25R3916_IO_INTERFACE_I2C)
#error "CONFIG_ST25R3916_IO_INTERFACE_SPI and CONFIG_ST25R3916_IO_INTERFACE_I2C must choose one only"
#endif

#ifndef CONFIG_ST25R3916_GPIO_IRQ_PIN
#define ST25R3916_GPIO_IRQ_PIN               hwGPIO_Pin_A0
#else
#define ST25R3916_GPIO_IRQ_PIN               CONFIG_ST25R3916_GPIO_IRQ_PIN
#endif

#if ST25R3916_IO_INTERFACE==ST25R3916_IO_INTERFACE_SPI
#ifndef CONFIG_ST25R3916_SPI_INDEX
#define ST25R3916_SPI_INDEX                  hwSPI_Index_0
#else
#define ST25R3916_SPI_INDEX                  CONFIG_ST25R3916_SPI_INDEX
#endif

#ifndef CONFIG_ST25R3916_SPI_CLOCK
#define ST25R3916_SPI_CLOCK                  100000
#else
#define ST25R3916_SPI_CLOCK                  CONFIG_ST25R3916_SPI_CLOCK
#endif

#ifndef CONFIG_ST25R3916_GPIO_CS_PIN
#define ST25R3916_GPIO_CS_PIN                hwGPIO_Pin_B6
#else
#define ST25R3916_GPIO_CS_PIN                CONFIG_ST25R3916_GPIO_CS_PIN
#endif
#endif

#if ST25R3916_IO_INTERFACE==ST25R3916_IO_INTERFACE_I2C
#ifndef CONFIG_ST25R3916_I2C_INDEX
#define ST25R3916_I2C_INDEX                  hwI2C_Index_0
#else
#define ST25R3916_I2C_INDEX                  CONFIG_ST25R3916_I2C_INDEX
#endif

#ifndef CONFIG_ST25R3916_I2C_SPEED_MODE
#define ST25R3916_I2C_SPEED_MODE             hwI2C_Standard_Mode
#else
#define ST25R3916_I2C_SPEED_MODE             CONFIG_ST25R3916_I2C_SPEED_MODE
#endif

#define ST25R3916_OP_TIMEOUT 1000
#endif
