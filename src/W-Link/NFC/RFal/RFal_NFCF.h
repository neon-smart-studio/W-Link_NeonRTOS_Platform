...
#define RFal_NFCF_IsNfcDepSupported( dev )  ( (((RFal_NFCF_ListenDevice*)(dev))->sensfRes.NFCID2[RFAL_NFCF_SENSF_NFCID2_BYTE1_POS] == RFAL_NFCF_SENSF_NFCID2_BYTE1_NFCDEP) && \
                                            (((RFal_NFCF_ListenDevice*)(dev))->sensfRes.NFCID2[RFAL_NFCF_SENSF_NFCID2_BYTE2_POS] == RFAL_NFCF_SENSF_NFCID2_BYTE2_NFCDEP)    )
...
typedef struct {
  uint8_t NFCID2[RFAL_NFCF_NFCID2_LEN];       /*!< NFCID2             */
} RFal_NFCF_PollDevice;

/*! NFC-F listener device (PICC) struct  */
typedef struct {
  uint8_t           sensfResLen;              /*!< SENF_RES length    */
  RFal_NFCF_SensfRes  sensfRes;                 /*!< SENF_RES           */
} RFal_NFCF_ListenDevice;

typedef  uint16_t RFal_NFCF_Serv;                 /*!< NFC-F Service Code */
...
typedef struct {
  ...
  RFal_FeliCaPollRes    POLL_F[RFAL_NFCF_POLL_MAXCARDS]; /*!< GRE_POLL_F   Activity 1.0 Table 10  */
} RFal_NFCF_GreedyF;
