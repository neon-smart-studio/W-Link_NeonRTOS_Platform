#ifndef PWM_PIN_STM32H5_H
#define PWM_PIN_STM32H5_H
...
static const PWM_AF_Map PWM_Pin_AF_Map[] =
{
    ...
    { hwTimer_Index_4, hwGPIO_Pin_F6, GPIO_AF2_TIM5 },
    { hwTimer_Index_4, hwGPIO_Pin_F7, GPIO_AF2_TIM5 },
    { hwTimer_Index_4, hwGPIO_Pin_F8, GPIO_AF2_TIM5 },
    { hwTimer_Index_4, hwGPIO_Pin_F9, GPIO_AF2_TIM5 },
#endif
...
#if defined(TIM15_BASE) && defined(GPIO_AF4_TIM15)
