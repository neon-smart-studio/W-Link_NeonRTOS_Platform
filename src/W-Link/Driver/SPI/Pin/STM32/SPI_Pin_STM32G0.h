#ifndef SPI_PIN_STM32G0_H
#define SPI_PIN_STM32G0_H
...
#endif
#if defined(SPI3_BASE)
    { hwSPI_Index_2, hwGPIO_Pin_A15, GPIO_AF4_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B3,  GPIO_AF4_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B4,  GPIO_AF4_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B5,  GPIO_AF4_SPI3 },
    
    { hwSPI_Index_2, hwGPIO_Pin_A4,  GPIO_AF9_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_C10, GPIO_AF9_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_C11, GPIO_AF9_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_C12, GPIO_AF9_SPI3 },
#endif
};

#endif // SPI_PIN_STM32G0_H