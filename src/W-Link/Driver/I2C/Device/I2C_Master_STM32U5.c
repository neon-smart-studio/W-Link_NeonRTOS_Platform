...
uint32_t I2C_Get_PCLK(hwI2C_Index index)
{
    ...
    if (index == hwI2C_Index_0) {
        uint32_t src = __HAL_RCC_GET_I2C1_SOURCE();
#if defined(RCC_I2C1CLKSOURCE_PCLK1)
        if (src == RCC_I2C1CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C1CLKSOURCE_SYSCLK)
        if (src == RCC_I2C1CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C1CLKSOURCE_HSI)
        if (src == RCC_I2C1CLKSOURCE_HSI) return HSI_VALUE;
#endif
    ...
    if (index == hwI2C_Index_1) {
        uint32_t src = __HAL_RCC_GET_I2C2_SOURCE();
#if defined(RCC_I2C2CLKSOURCE_PCLK1)
        if (src == RCC_I2C2CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C2CLKSOURCE_SYSCLK)
        if (src == RCC_I2C2CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C2CLKSOURCE_HSI)
        if (src == RCC_I2C2CLKSOURCE_HSI) return HSI_VALUE;
#endif
        return HAL_RCC_GetPCLK1Freq();
    }
#endif
    ...
    if (index == hwI2C_Index_2) {
        uint32_t src = __HAL_RCC_GET_I2C3_SOURCE();
#if defined(RCC_I2C3CLKSOURCE_PCLK1)
        if (src == RCC_I2C3CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C3CLKSOURCE_SYSCLK)
        if (src == RCC_I2C3CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C3CLKSOURCE_HSI)
        if (src == RCC_I2C3CLKSOURCE_HSI) return HSI_VALUE;
#endif
        return HAL_RCC_GetPCLK1Freq();
    }
#endif
    ...
    if (index == hwI2C_Index_3) {
        uint32_t src = __HAL_RCC_GET_I2C4_SOURCE();
#if defined(RCC_I2C4CLKSOURCE_PCLK1)
        if (src == RCC_I2C4CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C4CLKSOURCE_SYSCLK)
        if (src == RCC_I2C4CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C4CLKSOURCE_HSI)
        if (src == RCC_I2C4CLKSOURCE_HSI) return HSI_VALUE;
#endif
        return HAL_RCC_GetPCLK1Freq();
    }
#endif
    ...
    if (index == hwI2C_Index_4) {
        uint32_t src = __HAL_RCC_GET_I2C5_SOURCE();
#if defined(RCC_I2C5CLKSOURCE_PCLK1)
        if (src == RCC_I2C5CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C5CLKSOURCE_SYSCLK)
        if (src == RCC_I2C5CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C5CLKSOURCE_HSI)
        if (src == RCC_I2C5CLKSOURCE_HSI) return HSI_VALUE;
#endif
        return HAL_RCC_GetPCLK1Freq();
    }
#endif
    ...
    if (index == hwI2C_Index_5) {
        uint32_t src = __HAL_RCC_GET_I2C6_SOURCE();
#if defined(RCC_I2C6CLKSOURCE_PCLK1)
        if (src == RCC_I2C6CLKSOURCE_PCLK1) return HAL_RCC_GetPCLK1Freq();
#endif
#if defined(RCC_I2C6CLKSOURCE_SYSCLK)
        if (src == RCC_I2C6CLKSOURCE_SYSCLK) return HAL_RCC_GetSysClockFreq();
#endif
#if defined(RCC_I2C6CLKSOURCE_HSI)
        if (src == RCC_I2C6CLKSOURCE_HSI) return HSI_VALUE;
#endif
        return HAL_RCC_GetPCLK1Freq();
    }
#endif
...
#endif
#if defined(I2C6_BASE)
        case hwI2C_Index_5: return I2C6;
#endif
        default: break;
    }
...
#endif
#if defined(I2C5_BASE)
        case hwI2C_Index_4: __HAL_RCC_I2C5_CLK_ENABLE(); break;
#endif
#if defined(I2C6_BASE)
        case hwI2C_Index_5: __HAL_RCC_I2C6_CLK_ENABLE(); break;
#endif
        default: break;
    }
}
...
#endif
#if defined(I2C5_BASE)
        case hwI2C_Index_4: __HAL_RCC_I2C5_CLK_DISABLE(); break;
#endif
#if defined(I2C6_BASE)
        case hwI2C_Index_5: __HAL_RCC_I2C6_CLK_DISABLE(); break;
#endif
        default: break;
    }
}
...
#if defined(I2C6_BASE)
void I2C6_EV_IRQHandler(void) { I2C_HAL_EV_IRQHandler(hwI2C_Index_5); }
void I2C6_ER_IRQHandler(void) { I2C_HAL_ER_IRQHandler(hwI2C_Index_5); }
#endif
...
#if defined(I2C6_BASE)
        case hwI2C_Index_5:
            HAL_NVIC_SetPriority(I2C6_EV_IRQn, I2C_IRQ_NVIC_PRIORITY, I2C_IRQ_NVIC_SUB_PRIORITY);
            HAL_NVIC_EnableIRQ(I2C6_EV_IRQn);
            HAL_NVIC_SetPriority(I2C6_ER_IRQn, I2C_IRQ_NVIC_PRIORITY, I2C_IRQ_NVIC_SUB_PRIORITY);
