#ifndef SPI_PIN_STM32U5_H
#define SPI_PIN_STM32U5_H
...
{
#if defined(SPI1_BASE)
    { hwSPI_Index_0, hwGPIO_Pin_A1,  GPIO_AF5_SPI1 },
    ...
    { hwSPI_Index_0, hwGPIO_Pin_A11, GPIO_AF5_SPI1 },
    { hwSPI_Index_0, hwGPIO_Pin_A12, GPIO_AF5_SPI1 },
    { hwSPI_Index_0, hwGPIO_Pin_A15, GPIO_AF5_SPI1 },

    { hwSPI_Index_0, hwGPIO_Pin_B0,  GPIO_AF5_SPI1 },
...
#if defined(GPIOC)
    { hwSPI_Index_1, hwGPIO_Pin_C1,  GPIO_AF3_SPI2 },
    ...
    { hwSPI_Index_1, hwGPIO_Pin_D3,  GPIO_AF3_SPI2 },
