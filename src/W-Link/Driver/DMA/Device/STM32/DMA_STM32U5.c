...
static const hwDMA_Channel_Index UART_DMA_Channel_Map[hwUART_Index_MAX][hwDMA_Peripheral_Direction_MAX] =
{
    ...
    {hwDMA_Channel_Index_0, hwDMA_Channel_Index_1}, // USART1_TX DMA1_CH4, RX DMA1_CH5
#endif
#if defined (UART2_BASE) || defined(USART2_BASE)
    {hwDMA_Channel_Index_2, hwDMA_Channel_Index_3}, // USART2_TX DMA1_CH7, RX DMA1_CH6
#endif
#if defined (UART3_BASE) || defined(USART3_BASE)
    {hwDMA_Channel_Index_4, hwDMA_Channel_Index_5}, // USART3_TX DMA1_CH2, RX DMA1_CH3
#endif
#if defined (UART4_BASE) || defined(USART4_BASE)
    {hwDMA_Channel_Index_6, hwDMA_Channel_Index_7}, // UART4_TX DMA2_CH5, RX DMA2_CH3
#endif
#if defined (UART5_BASE) || defined(USART5_BASE)
    {hwDMA_Channel_Index_8, hwDMA_Channel_Index_9}, // UART5_TX DMA2_CH2, RX DMA2_CH1
#endif
#if defined (UART6_BASE) || defined(USART6_BASE)
    {hwDMA_Channel_Index_14, hwDMA_Channel_Index_15}, // UART5_TX DMA2_CH2, RX DMA2_CH1
#endif
#if defined (LPUART1_BASE)
    {hwDMA_Channel_Index_16, hwDMA_Channel_Index_17}, // USART1_TX DMA1_CH4, RX DMA1_CH5
#endif
};
...
static const hwDMA_Channel_Index SPI_DMA_Channel_Map[hwSPI_Index_MAX][hwDMA_Peripheral_Direction_MAX] =
{
    ...
    {hwDMA_Channel_Index_0, hwDMA_Channel_Index_1}, // SPI1_TX DMA1_CH3, RX DMA1_CH2
#endif
#if defined(SPI2_BASE)
    {hwDMA_Channel_Index_2, hwDMA_Channel_Index_3}, // SPI2_TX DMA1_CH5, RX DMA1_CH4
#endif
#if defined(SPI3_BASE)
    {hwDMA_Channel_Index_4, hwDMA_Channel_Index_5}, // SPI3_TX DMA2_CH2, RX DMA2_CH1
#endif
};
...
static const hwDMA_Channel_Index I2C_DMA_Channel_Map[hwI2C_Index_MAX][hwDMA_Peripheral_Direction_MAX] =
{
    ...
    {hwDMA_Channel_Index_8, hwDMA_Channel_Index_9}, // I2C2_TX DMA1_CH4, RX DMA1_CH5
#endif
#if defined(I2C3_BASE)
    {hwDMA_Channel_Index_10, hwDMA_Channel_Index_11}, // I2C3_TX DMA2_CH2, RX DMA2_CH1
#endif
#if defined(I2C4_BASE)
    {hwDMA_Channel_Index_12, hwDMA_Channel_Index_13}, // I2C3_TX DMA2_CH2, RX DMA2_CH1
#endif
};
