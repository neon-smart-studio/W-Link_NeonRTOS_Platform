#ifndef UART_PIN_STM32L0_H
#define UART_PIN_STM32L0_H
...
#if defined(USART1_BASE) && defined(GPIO_AF4_USART1)
    { hwUART_Index_0, hwGPIO_Pin_A9,  GPIO_AF4_USART1 },
    { hwUART_Index_0, hwGPIO_Pin_A10, GPIO_AF4_USART1 },
    { hwUART_Index_0, hwGPIO_Pin_B6,  GPIO_AF4_USART1 },
    { hwUART_Index_0, hwGPIO_Pin_B7,  GPIO_AF4_USART1 },
#elif defined(USART1_BASE) && defined(GPIO_AF7_USART1)
...
#if defined(USART2_BASE) && defined(GPIO_AF4_USART2)
    { hwUART_Index_1, hwGPIO_Pin_A2,  GPIO_AF4_USART2 },
    { hwUART_Index_1, hwGPIO_Pin_A3,  GPIO_AF4_USART2 },
    { hwUART_Index_1, hwGPIO_Pin_A14, GPIO_AF4_USART2 },
    { hwUART_Index_1, hwGPIO_Pin_A15, GPIO_AF4_USART2 },
#elif defined(USART2_BASE) && defined(GPIO_AF7_USART2)
...
#if defined(USART3_BASE) && defined(GPIO_AF4_USART3)
...
#elif defined(USART3_BASE) && defined(GPIO_AF7_USART3)
...
#if (defined(UART4_BASE) || defined(USART4_BASE)) && defined(GPIO_AF6_USART4)
    { hwUART_Index_3, hwGPIO_Pin_A0, GPIO_AF6_USART4 },
    { hwUART_Index_3, hwGPIO_Pin_A1, GPIO_AF6_USART4 },
#elif (defined(UART4_BASE) || defined(USART4_BASE)) && defined(GPIO_AF8_UART4)
    { hwUART_Index_3, hwGPIO_Pin_A0, GPIO_AF8_UART4 },
    { hwUART_Index_3, hwGPIO_Pin_A1, GPIO_AF8_UART4 },
#endif

#if (defined(UART4_BASE) || defined(USART4_BASE)) && defined(GPIO_AF6_USART4)
    { hwUART_Index_3, hwGPIO_Pin_C10, GPIO_AF6_USART4 },
    { hwUART_Index_3, hwGPIO_Pin_C11, GPIO_AF6_USART4 },
#elif (defined(UART4_BASE) || defined(USART4_BASE)) && defined(GPIO_AF5_UART4)
    { hwUART_Index_3, hwGPIO_Pin_C10, GPIO_AF5_UART4 },
    { hwUART_Index_3, hwGPIO_Pin_C11, GPIO_AF5_UART4 },
#endif

#if (defined(UART5_BASE) || defined(USART5_BASE)) && defined(GPIO_AF6_USART5)
    { hwUART_Index_4, hwGPIO_Pin_C12, GPIO_AF6_USART5 },
    { hwUART_Index_4, hwGPIO_Pin_D2,  GPIO_AF6_USART5 },
#elif (defined(UART5_BASE) || defined(USART5_BASE)) && defined(GPIO_AF5_UART5)
    { hwUART_Index_4, hwGPIO_Pin_C12, GPIO_AF5_UART5 },
    { hwUART_Index_4, hwGPIO_Pin_D2,  GPIO_AF5_UART5 },
#endif

#if defined(LPUART1_BASE) && defined(GPIO_AF6_LPUART1)
    { hwUART_Index_L1, hwGPIO_Pin_A2,  GPIO_AF6_LPUART1 },
    { hwUART_Index_L1, hwGPIO_Pin_A3,  GPIO_AF6_LPUART1 },
    { hwUART_Index_L1, hwGPIO_Pin_B10, GPIO_AF6_LPUART1 },
    { hwUART_Index_L1, hwGPIO_Pin_B11, GPIO_AF6_LPUART1 },
#elif defined(LPUART1_BASE) && defined(GPIO_AF8_LPUART1)
