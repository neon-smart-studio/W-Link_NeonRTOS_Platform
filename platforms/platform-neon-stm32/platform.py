    ...
    def configure_default_packages(self, variables, targets):
        ...
        if "cmsis" in frameworks:
            ...
            if mcu.startswith("stm32wba"):
                device_package = "framework-cmsis-stm32wba"

            elif mcu.startswith("stm32h7r") or mcu.startswith("stm32h7s"):
                device_package = "framework-cmsis-stm32h7rs"

            else:
                device_package = "framework-cmsis-" + mcu[0:7]
