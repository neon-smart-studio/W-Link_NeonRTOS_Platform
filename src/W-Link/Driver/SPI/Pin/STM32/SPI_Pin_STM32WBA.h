#ifndef SPI_PIN_STM32WBA_H
#define SPI_PIN_STM32WBA_H
...
#if defined(SPI3_BASE)
    { hwSPI_Index_2, hwGPIO_Pin_B12, GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B13, GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B14, GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B15, GPIO_AF6_SPI3 },

    { hwSPI_Index_2, hwGPIO_Pin_B9,  GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_B10, GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_C2,  GPIO_AF6_SPI3 },
    { hwSPI_Index_2, hwGPIO_Pin_C3,  GPIO_AF6_SPI3 },
#endif
};

#endif // SPI_PIN_STM32WBA_H